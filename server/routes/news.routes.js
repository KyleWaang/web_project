...
router.route("/api/newss/:newsId").get(newsCtrl.read);
router.route("/api/newss/:newsId").put(newsCtrl.update);
router.route("/api/newss/:newsId").delete(newsCtrl.remove);
